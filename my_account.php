...
<!-- Mirrored from www.annimexweb.com/items/hema/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 07:30:41 GMT -->
<head>
                    ...
                    <div class="row">
                            ...
                            <div class="dashboard-sidebar bg-block">
                                ...
                                <div class="dashboard-tab">
                                    <ul class="nav nav-tabs flex-lg-column border-bottom-0" id="top-tab" role="tablist">
                                        ...
                                        <li class="nav-item"><a href="#" data-bs-toggle="tab" data-bs-target="#orders" class="nav-link">Products Orders</a></li>
                                        <li class="nav-item"><a href="#" data-bs-toggle="tab" data-bs-target="#corders" class="nav-link">Course Orders</a></li>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-9">
                            <div class="dashboard-content tab-content h-100" id="top-tabContent">
                                ...
                                <div class="tab-pane fade h-100 show active" id="info">
                                    <div class="account-info h-100">
                                        <div class="welcome-msg mb-4">
                                            <h2>Hello, <span class="text-primary">Your Name</span></h2>
                                        ...
                                        <div class="account-box">
                                            ...
                                            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                                <div class="box-info mb-4">
                                                    ...
                                                    <div class="box-content mt-3 ps-3">
                                ...
                                <!-- Orders tracking -->
                                <div class="tab-pane fade h-100" id="corders">
                                    <div class="orders-card mt-0 h-100">    
                                        <div class="top-sec d-flex-justify-center justify-content-between mb-4">
                                            <h2 class="mb-0">My Orders</h2>
                                        </div>
...
<!-- Mirrored from www.annimexweb.com/items/hema/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 07:30:51 GMT -->
</html>