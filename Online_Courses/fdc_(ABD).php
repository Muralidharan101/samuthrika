                        ...
                        <div
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="fdc_des(ABD).php" class="product-img">
                                            <!-- Image -->
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            ...
                                            <div class="product-name">
                                                <a href="fdc_des(ABD).php">Diploma In Fashion Designing</a>
                                            </div>
                                            <!-- End Product Name -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="fdc_des2(ABD).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="fdc_des2(ABD).php">Advanced Diploma In Fashion Designing</a>
                                            </div>
                                            <!-- End Product Name -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="fdc_des3(ABD).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="fdc_des3(ABD).php">Master Diploma In Fashion Designing</a>
                                            </div>
                                            <!-- End Product Name -->
