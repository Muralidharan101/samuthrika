                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span class="price old-price basic-price" style="display:none;">₹7,500</span><span
                                        class="price basic-price" style="display:none;">₹6500</span>

                                    <span class="price old-price advance-price" style="display:none;">₹9500</span><span
                                        class="price advance-price" style="display:none;">₹8500</span>

                                        <span class="price old-price diploma-price" style="display:none;">₹23000</span><span
                                        class="price diploma-price" style="display:none;">₹22000</span>
                                </div>
                                <!-- End Product Price -->
