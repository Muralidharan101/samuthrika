...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Jewellery Making Abroad</title>
...
<br>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span class="price old-price basic-price" style="display:none;">₹7,000</span><span
                                        class="price basic-price bprice" style="display:none;">₹6,000</span>

                                    <span class="price old-price advance-price" style="display:none;">₹9,000</span><span
                                        class="price advance-price aprice" style="display:none;">₹8,000</span>

                                    <span class="price old-price diploma-price" style="display:none;">₹22,500</span><span
                                        class="price diploma-price dprice" style="display:none;">₹21,500</span>
                                </div>
                                <!-- End Product Price -->
