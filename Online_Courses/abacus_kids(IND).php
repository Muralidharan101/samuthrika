...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Abacus india</title>
    <!--BootStrap icons-->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2">
                                    <span style="display:none" class="price old-price zero_price">₹4,500</span><span
                                        style="display:none"
                                        class="price zero_price zprice">₹3,500<span>&nbsp;</span></span>
                                    <span style="display:none" class="price old-price first_price">₹5,000</span><span
                                        style="display:none"
                                        class="price first_price fprice">₹4,000<span>&nbsp;</span></span>

                                    <span style="display:none" class="price old-price second_price">₹5,500</span><span
                                        style="display:none"
                                        class="price second_price sprice">₹4,500<span>&nbsp;</span></span>

                                    <span style="display:none" class="price old-price third_price">₹6,000</span><span
                                        style="display:none"
                                        class="price third_price tprice">₹5,500<span>&nbsp;</span></span>
