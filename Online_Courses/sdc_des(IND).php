                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/aari.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/aari.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Aari Embroidery
                                </h2>
                                <!-- Product Info -->
                                ...
                                <div class="form-check level">
                                                ...
                                                <label for="basic" class="me-3">Basic - 20 Hours</label>
                                                <input id="adv" name="level" type="radio" value="Advance"  />

                                                <label for="adv" class="me-3">Advance - 30 Hours</label>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span  class="price old-price basic-price" style="display:none;">₹7,500</span><span
                                         class="price basic-price bprice" style="display:none;">₹6,500</span>

                                         <span  class="price old-price advance-price" style="display:none;">₹11500</span><span
                                         class="price advance-price aprice" style="display:none;">₹10500</span>
                                </div>
                                <!-- End Product Price -->
