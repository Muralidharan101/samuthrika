                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span  class="price old-price basic-price" style="display:none;">₹8,000</span><span
                                         class="price basic-price" style="display:none;">₹7000</span>

                                         <span  class="price old-price advance-price" style="display:none;">₹12000</span><span
                                         class="price advance-price" style="display:none;">₹11000</span>
                                </div>
                                <!-- End Product Price -->
