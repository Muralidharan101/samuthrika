...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Abacus Class In Abroad</title>
    <!--BootStrap icons-->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2">
                                    <span style="display:none" class="price old-price zero_price">₹5,000</span><span style="display:none" class="price zero_price">₹4500<span>&nbsp;(for 3 months)</span></span>
                                        <span style="display:none"  class="price old-price first_price">₹5,500</span><span style="display:none" class="price first_price">₹5000<span>&nbsp;(for 3 months)</span></span>

                                        <span style="display:none" class="price old-price second_price">₹6,000</span><span style="display:none" class="price second_price">₹5500<span>&nbsp;(for 3 months)</span></span>

                                        <span style="display:none" class="price old-price third_price">₹7,000</span><span style="display:none" class="price third_price">₹6500<span>&nbsp;(for 3 months)</span></span>
