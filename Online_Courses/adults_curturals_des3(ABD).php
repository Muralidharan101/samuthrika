...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Zumba Adults Abroad</title>
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/Zumba.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/Zumba.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price twice-price">₹3,500</span><span
                                        style="display:none" class="price twice-price tp">₹3,000</span>

                                    <span style="display:none" class="price old-price thrice-price">₹4,000</span><span
                                        style="display:none" class="price thrice-price thp">₹3,500</span>


                                    <span style="display:none" class="price old-price five-price">₹4,500</span><span
                                        style="display:none" class="price five-price fp">₹4,000</span>


                                    <span style="display:none" class="price old-price weekend-price">₹3,500</span><span
                                        style="display:none" class="price weekend-price wp">₹3,000</span>
                                </div>
                                <!-- End Product Price -->
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>Zumba is a form of Dance and it was handed since our Academy proprietor is a
                                            Certified License Holder of Zumba. Anyone interested in joining Zumba can
                                            enjoy the benefits of Zumba.</p>
