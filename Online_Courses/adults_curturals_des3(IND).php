...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Zumba Adults India</title>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price twice-price">₹2,500</span><span
                                        style="display:none" class="price twice-price tp">₹2,000</span>

                                    <span style="display:none" class="price old-price thrice-price">₹3,000</span><span
                                        style="display:none" class="price thrice-price thp">₹2,500</span>
                                    ...
                                    <span style="display:none" class="price old-price weekend-price">₹2,500</span><span
                                        style="display:none" class="price weekend-price wp">₹2,000</span>
                                </div>
                                <!-- End Product Price -->
