                                ...
                                <div class="product-info">
                                   ...
                                   <div class="product-price d-flex-center my-2">
                                        <span style="display:none" class="price old-price one-price">₹4,000</span><span
                                            style="display:none" class="price one-price">₹3500</span>
                                        <span style="display:none" class="price old-price two-price">₹6,000</span><span
                                            style="display:none" class="price two-price">₹5500</span>
                                        <span style="display:none"
                                            class="price old-price three-price">₹8,000</span><span style="display:none"
                                            class="price three-price">₹7500</span>
                                    </div>
                                    <!-- End Product Price -->
