...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Summer Camp For Adults In Abroad </title>
    <!--BootStrap icons-->
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-price d-flex-center my-2">
                                        <span style="display:none" class="price old-price one-price">₹4,000</span><span
                                            style="display:none" class="price one-price oprice">₹3,500</span>
                                        <span style="display:none" class="price old-price two-price tprice">₹6,000</span><span
                                            style="display:none" class="price two-price">₹5,500</span>
                                        <span style="display:none"
                                            class="price old-price three-price">₹8,000</span><span style="display:none"
                                            class="price three-price thprice">₹7,500</span>
                                    </div>
                                    <!-- End Product Price -->
        ...
        $('.form-check input[name="hour"]').change(function () {
            ...
            for (var i = 1; i <= parseInt(selectedValue.charAt(0)); i++) {
                ...
                newSelectBox.change(function () {
                    ...
                    $('.classes').not(this).find(`option[value="${selectedOption}"]`).show();
