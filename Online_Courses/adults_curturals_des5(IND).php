...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Carnatic Vocal Adults India</title>
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/carnatic.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/carnatic.jpg"
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>Carnatic Vocal is a musical instrument, where we learn both for time pass as well
                    ...
                    $("#submit").click(function () {
                        ...
                        if (cookieValue === null) {
                            ...
                            if (week == null) {
                                ...
                                fd.append("id", "432");
                                fd.append('course_name', "Carnatic Vocal");
