...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Hand Embroidery Abroad</title>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span class="price old-price advance-price" style="display:none;">₹8,000</span><span
                                        class="price advance-price aprice" style="display:none;">₹7,000</span>
                                </div>
                                <!-- End Product Price -->
