...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Summer Camp For Adults In India</title>
    <!--BootStrap icons-->
                                ...
                                <div class="product-info">
                                    ...
                                    <!-- End Product Info -->
                                     ...
                                     <div class="product-price d-flex-center my-2">
                                        <span style="display:none" class="price old-price one-price">₹3,000</span><span
                                            style="display:none" class="price one-price">₹2500</span>
                                        <span style="display:none" class="price old-price two-price">₹5,000</span><span
                                            style="display:none" class="price two-price">₹4500</span>
                                        <span style="display:none"
                                            class="price old-price three-price">₹7,000</span><span style="display:none"
                                            class="price three-price">₹6500</span>
                                    </div>
                                    <!-- End Product Price -->
