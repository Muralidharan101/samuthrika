...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Spoken English Kids India </title>
    <!--BootStrap icons-->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price basic-price ">₹3,500</span><span
                                        style="display:none" class="price basic-price bprice">₹3000</span>
                                    <span style="display:none" class="price old-price advance-price ">₹7,500</span><span
                                        style="display:none" class="price advance-price aprice">₹7,000</span>
                                </div>
                                <!-- End Product Price -->
