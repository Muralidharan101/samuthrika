...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Yoga Class Kids Abroad</title>
    <!--BootStrap icons-->
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price basic-price ">₹2,500</span><span
                                        style="display:none" class="price basic-price bprice">₹2,000</span>
                                    <span style="display:none" class="price old-price advance-price ">₹3,000</span><span
                                        style="display:none" class="price advance-price aprice">₹2,500</span>
                                </div>
                                <!-- End Product Price -->
