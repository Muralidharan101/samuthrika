...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Dance on floor Adults Abroad </title>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price twice-price">₹3,200</span><span
                                        style="display:none" class="price twice-price tp">2,700</span>

                                    <span style="display:none" class="price old-price thrice-price">₹3,500</span><span
                                        style="display:none" class="price thrice-price thp">₹3,000</span>


                                    <span style="display:none" class="price old-price five-price">₹4,000</span><span
                                        style="display:none" class="price five-price fp">₹3,500</span>


                                    <span style="display:none" class="price old-price weekend-price">₹3,200</span><span
                                        style="display:none" class="price weekend-price wp">₹2,700</span>
                                </div>
                                <!-- End Product Price -->
