        ...
        <div id="page-content">
            ...
            <section style="padding-top:10px" class="section product-slider">
                ...
                <div class="section-header">
                        ...
                        <h1 style="font-size:2rem ; color:orange;" class="">TRAINING COURSES FOR ADULTS - INDIA(online)</h1>
                    </div>
                        ...
                        <div
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="adults_training_des(IND).php" class="product-img">
                                            <!-- Image -->
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            ...
                                            <div class="product-name">
                                                <a href="adults_training_des(IND).php">Hand Writing</a>
                                            </div>
                                            <!-- End Product Name -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="adults_training_des2(IND).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_training_des2(IND).php">Speed Writing</a>
                                            </div>
                                            <!-- End Product Name -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="adults_training_des3(IND).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_training_des3(IND).php">Calligraphy</a>
                                            </div>
                                            <!-- End Product Name -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="adults_training_des4(IND).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_training_des4(IND).php">Spoken English</a>
                                            </div>
                                            <!-- End Product Name -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="adults_training_des5(IND).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_training_des5(IND).php">Spoken Hindi</a>
                                            </div>
                                            <!-- End Product Name -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="adults_training_des6(IND).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_training_des6(IND).php">Hindi Reading & Writing
                                                    </a>
                                            </div>
                                            <!-- End Product Name -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="adults_training_des7(IND).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_training_des7(IND).php">English Reading & Writing
                                                    </a>
                                            </div>
                                            <!-- End Product Name -->
                    ...
                    <div class="section-header mt-5">
                        ...
                        <h1 style="font-size:2rem ; color:orange;" class="">SUMMER CAMP FOR ADULTS - INDIA(online)</h1>
                    </div>
                        ...
                        <div
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="summer_camp_adults(IND).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="summer_camp_adults(IND).php">SUMMER CAMP FOR ADULTS</a>
