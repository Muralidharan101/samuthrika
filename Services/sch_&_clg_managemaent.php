                    ...
                    <div class="container">
                        <div class="section-header d-none">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="section-header">
                                    <h1 style="font-size:2.3rem" class="pt-4"> Courses for <span
                                            style="color:orange;">School & College Tie-ups</span></h1>
                                </div>
                                ...
                                <table id="product-table" class="table  table-secondary bg-secondary text-dark  table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>18</td>
                                        <td>Saree Drapping</td>
                                            <td>
                                                <div class="form-check lang">


                                                    <input id="c1" name="course" type="checkbox"
                                                        value="Saree Drapping" />
