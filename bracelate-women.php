...
$(document).ready(function(){
    ...
    function fetchdata(){   
                ...
                $.ajax({
                    url: 'dashboard/main/ajax/jewel/list_jewel.php',
                    type: 'get',
                        ...
                        <div class="item col-item" >
                            ...
                            <div class="product-box">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product_jewel_desc.php?id=${value.id}" class="product-img rounded-0">
                                        
                                        <img class=""
                                            data-src="dashboard/main/product_jewel_images/${value.id}/${value.product_img}"
                                            src="dashboard/main/product_jewel_images/${value.id}/${value.product_img}"
                                ...
                                <div class="product-details text-left">
                                        <div class="product-vendor">Product-Jewels</div>
