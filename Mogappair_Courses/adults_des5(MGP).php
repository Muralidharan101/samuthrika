...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Spoken hindi Adults mogappair</title>
    <!--BootStrap icons-->
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/spk-hin.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/spk-hin.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Spoken Hindi
                                </h2>
                                <!-- Product Info -->
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>
                                            Hindi is a language, so we clearly say definitely we should give good time
                                            to learn from scratch. So we offer spoken as a one month course for students
                                            already know hindi but struggling to converse and as a three months course
                                            for students who wish to learn hindi from scratch.</p>
                                            
                                        <h4 class="mb-3">Features</h4>
                                        <ul class="checkmark-info">
                                            <li> Assured improvement in speaking hindi</li>
                                            <li>Spoken Hindi mainly for adults who got recruited in North and need to
                                            speak Hindi within a short period.</li>
                                            <li> Curriculum which is more interesting to learn and speak Hindi</li>
                                            <li>Basic and Advance courses are available at convenient timing</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            $("#submit").click(function () {
                ...
                if (cookieValue === null) {
                    ...
                    if (level == null) {
                        ...
                        fd.append("id","826");
                        fd.append('course_name', "Spoken Hindi");
                        fd.append('age_grp', "adults");
                        fd.append('level', level);
                        fd.append('price', price);
                        fd.append('location', "mogsppair");
