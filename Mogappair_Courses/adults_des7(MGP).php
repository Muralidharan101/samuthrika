                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            ...
                                            data-zoom-image="<?php echo $path;?>assets/images/class-10.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">English Reading And Writing  Class
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Languages: <span> <a href="#">English</a>  </span></p>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span  style="display:none" class="price old-price advance-price">₹4,500</span><span  style="display:none" class="price advance-price">₹4000</span>
                                </div>
                                <!-- End Product Price -->
