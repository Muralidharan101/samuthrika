                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/speed-write.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/speed-write.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Speed Writing Class
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                p class="product-cat"><i class="bi bi-book"></i> Languages: <span> <a href="#">English</a> </p>
