...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Training Course For Adults Mogappair</title>
    <!-- Favicon -->
        ...
        <div id="page-content">
            ...
            <section style="padding-top:10px" class="section product-slider">
                ...
                <div class="section-header">
                        ...
                        <h1 style="font-size:2rem ; color:orange;" class="">TRAINING COURSES FOR ADULTS - MOGAPPAIR</h1>
                    </div>
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_des4(MGP).php">Spoken English</a>
                                            </div>
                                            <!-- End Product Name -->
