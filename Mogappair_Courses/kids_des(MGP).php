...
<style>
    ...
    .basicAdvance #basic, #advance {
       accent-color:black;
    }

    
    .lang #tamil , #eng ,#hindi{
       accent-color:black;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">HandWriting Class
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                <p class="product-cat"><i class="bi bi-book"></i> Languages:  <span>
                                        <div class="form-check lang">
                                        <input id="tamil" name="lang" type="radio" value="tamil" required />

                                                <label for="tamil" class="me-3">Tamil</label>
                                                <input id="eng" name="lang" type="radio"  value="eng" required />

                                                <label for="eng" class="me-3" >English</label>
                                                <input id="hindi" name="lang" type="radio"  value="hindi" required />
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Hours : <span><a
                                                href="#">Per day 1 hour</a> </span></p>
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Level :
                                        <span>
                                        <div class="form-check basicAdvance">
                                        <input id="basic" name="basic" type="radio" value="basic" required />

                                                <label for="basic" class="me-3">Basic - 15 days</label>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price basic-price">₹2,500</span><span  style="display:none" class="price basic-price">₹2000</span>
                                    <span  style="display:none" class="price old-price advance-price">₹3,000</span><span  style="display:none" class="price advance-price">₹2500</span>
                                </div>
                                <!-- End Product Price -->
                            ...
                            <div class="social-sharing d-flex-center mt-2 lh-lg">
                                ...
                                <a href="#" class="d-flex-center btn btn-link btn--share share-facebook"><i
                                        ...
                                        class="share-title">Facebook</span></a>
                                ...
                                <a href="#" class="d-flex-center btn btn-link btn--share share-linkedin"><i
                                        ...
                                        class="share-title">Linkedin</span></a>
                                    ...
                                    <div class="spr-reviews">
                                        ...
                                        <div class="review-inner">
                                            <div class="spr-review d-flex w-100">
                                                <div class="spr-review-profile flex-shrink-0">
                                                    <img class="blur-up lazyload"
                                                        data-src="<?php echo $path;?>assets/images/users/user-img1.jpg"
                                                        src="<?php echo $path;?>assets/images/users/user-img1.jpg"
                                            ...
                                            <div class="spr-review d-flex w-100">
                                                <div class="spr-review-profile flex-shrink-0">
                                                    <img class="blur-up lazyload"
                                                        data-src="<?php echo $path;?>assets/images/users/testimonial1.jpg"
                                                        src="<?php echo $path;?>assets/images/users/testimonial1.jpg"
                                                        alt="" width="200" height="200" />
                                                </div>
                                                <div class="spr-review-content flex-grow-1">
                                                    <div class="d-flex justify-content-between flex-column mb-2">
