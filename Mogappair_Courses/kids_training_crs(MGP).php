...
<head>
        ...
        <!-- Title Of Site -->
        <title>Samuthrika Academy | Mogappair</title>
        <!-- Favicon -->
                ...
                <section style="padding-top:10px" class="section product-slider">
                    <div class="container">
                        ...
                        <div class="grid-products grid-view-items pro-hover3">
                            <div class="row col-row product-options row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2">                                                                              
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                ...
                                                <div class="product-name">
                                                    <a href="kids_des(MGP).php">Handwriting Classes</a>
                                                </div>
                                                <!-- End Product Name -->
                                             ...
                                             <div class="product-duration py-2 pb-0">
                                                        ...
                                                        <li style="font-size:11px;"><i class="bi bi-calendar-check"></i><span> Basic - 15 days</span></li>
                                                        <li style="font-size:11px;"><i class="bi bi-book"></i><span> (English/Tamil/Hindi)</span></li>
                                                        </ul>
                                                        </div>
                                                         <!-- End Product Details -->
                                                        ...
                                                        <div class="blog-content py-2 pb-0">
                                                            <ul class="publish-detail d-flex-nowrap justify-content-between text-uppercase mb-2">                      
                                                                  <li style="font-size:11px;"><i class="icon anm anm-calendar"></i> <time datetime="">Mon - Fri ( Per Day 1hr )</time></li>
                                                            </ul>
                                                            </div>
                                                             <!-- End Product Details -->
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="kids_des2(MGP).php">Speed Writing Class</a>
                                                </div>
                                                <!-- End Product Name -->
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="kids_des3(MGP).php">Calligraphy Class</a>
                                                </div>
                                                <!-- End Product Name -->
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="kids_des4(MGP).php">Spoken English Class</a>
                                                </div>
                                                <!-- End Product Name -->
                                             ...
                                             <div class="product-duration py-2 pb-0">
                                                        ...
                                                        <li style="font-size:11px;"><i class="bi bi-calendar-check"></i><span> Advanced - 60 days</span></li>
                                                        </ul>
                                                        </div>
                                                         <!-- End Product Details -->
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="kids_des5(MGP).php">Spoken Hindi Class</a>
                                                </div>
                                                <!-- End Product Name -->
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a href="kids_des6(MGP).php" class="product-img">
                                                   ...
                                                   <img class="primary blur-up lazyload" data-src="<?php echo $path; ?>assets/images/english class.jpg" src="<?php echo $path; ?>assets/images/english class.jpg" alt="Product" title="Product" width="625" height="781" />
                                                            <!-- End Image -->
                                                            <!-- Hover Image -->
                                                            <img class="hover blur-up lazyload" data-src="<?php echo $path; ?>assets/images/english class.jpg" src="<?php echo $path; ?>assets/images/english class.jpg" alt="Product" title="Product" width="625" height="781" />
                                                            <!-- End Hover Image -->
                                            </a>
                                            <!-- End Product Image -->
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="kids_des6(MGP).php">Hindi Reading & Writing Classes</a>
                                                </div>
                                                <!-- End Product Name -->
                                             ...
                                             <div class="product-duration py-2 pb-0">
                                                        <ul class="publish-detail d-flex-wrap justify-content-between text-uppercase mb-2">                      
                                                        <li style="font-size:11px;"><i class="bi bi-calendar-check"></i><span> Basic - 20 days</span></li>
                                                        <li style="font-size:11px;"><i class="bi bi-calendar-check"></i><span> Advanced - 40 days</span></li>
                                                        </ul>
                                                        </div>
                                                         <!-- End Product Details -->
                                    ...
                                    <div class="product-box">
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="kids_des7(MGP).php">English Reading & Writing Classes</a>
                                                </div>
                                                <!-- End Product Name -->
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="abacus_kids(MGP).php" class="product-img">
                                            <!-- Image -->
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name">
                                            <a href="abacus_kids(MGP).php">Abacus Class</a>
                        ...
                        <p class="mb-2 mt-0">Education is the most powerful weapon which you can use to change the
                            world.</p>
                        <h1 style="font-size:2rem ; color:orange;" class="">SCHOOL TUTION FOR LKG - XII IN MOGAPPAIR (W)</h1>
                    </div>
                        ...
                        <div
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_pkg(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_pkg(MGP).php">Class PRE-KG</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_lkg(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_lkg(MGP).php">Class LKG</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_ukg(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload "
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_ukg(MGP).php">Class UKG</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_1(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_1(MGP).php">Class I</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_2(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_2(MGP).php">Class II</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_3(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_3(MGP).php">Class III</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_4(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_4(MGP).php">Class IV</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_5(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_5(MGP).php">Class V</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_6(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_6(MGP).php">Class VI</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_7(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_7(MGP).php">Class VII</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_8(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_8(MGP).php">Class VIII</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_9(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_9(MGP).php">Class IX</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_10(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_10(MGP).php">Class X</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_11(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_11(MGP).php">Class XI</a>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="scl_12(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="scl_12(MGP).php">Class XII</a>
                    ...
                    <div class="section-header mt-5">
                        ...
                        <h1 style="font-size:2rem ; color:orange;" class="">SUMMER CAMP FOR KIDS IN MOGAPPAIR (W) </h1>
                    </div>
                        ...
                        <div
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="summer_camp(MGP).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <!-- Product Name -->
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="summer_camp(MGP).php">SUMMER CAMP FOR KIDS</a>
