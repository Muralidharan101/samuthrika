...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy HandWriting Adults Mogappair</title>
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            ...
                                            data-zoom-image="<?php echo $path;?>assets/images/handwriting-classes.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">HandWriting
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Languages: <span>
                                            <div class="form-check lang">
                                                <input id="tamil" name="lang" type="radio" value="tamil" />

                                                <label for="tamil" class="me-3">Tamil</label>
                                                <input id="eng" name="lang" type="radio" value="english" />

                                                <label for="eng" class="me-3">English</label>
                                                <input id="hindi" name="lang" type="radio" value="hindi" />
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Hours : <span><a
                                                href="#">perDay/1hr</a> </span></p>
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Duration :
                                        <span>
                                            15 Days
                                        </span>
                                    </p>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span class="price old-price basic-price" id="dup_price">₹2,500</span><span
                                        class="price basic-price" id="price">₹2000</span>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p style="text-align: left;">
                                            We provide Handwriting Improvement Courses as a Money Back Guarantee for all
                                            ages,
                                            especially from Pre School kids to Adults and so far have done with 9 School
                                            tie-ups.
                                            We follow a different methodology to improve cursive Handwriting. We
                                            believe,
                                            making students write 'A' 100 times will not result in good handwriting, and
                                            so we focus on teaching them how to write 'A' in a perfect way for lifelong
                                            using a methodology.
                                        </p>
                                        ...
                                        <ul class="checkmark-info">
                                            ...
                                            <li>7 to 15 Days Guaranteed Results</li>
                                            <li>1st Day sample taken and End of the Results are shown</li>
                                            <li> 12 years of experience in improving Handwriting to more than 6000 students</li>
