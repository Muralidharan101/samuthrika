...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Abacus Mogappair</title>
    <!--BootStrap icons-->
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/abacus.jpg"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Levels : <span>
                                ...
                                <div class="product-price d-flex-center my-2">
                                    <span style="display:none" class="price old-price zero_price">₹4,000</span><span
                                        style="display:none"
                                        class="price zero_price zprice">₹3000<span>&nbsp;</span></span>
                                    <span style="display:none" class="price old-price first_price">₹4,500</span><span
                                        style="display:none"
                                        class="price first_price fprice">₹3500<span>&nbsp;</span></span>

                                    <span style="display:none" class="price old-price second_price">₹5,000</span><span
                                        style="display:none"
                                        class="price second_price sprice">₹4000<span>&nbsp;</span></span>

                                    <span style="display:none" class="price old-price third_price">₹6,000</span><span
                                        style="display:none"
                                        class="price third_price tprice">₹5000<span>&nbsp;</span></span>
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>Abacus is not meant to improve or score Maths subject , we ensure Speed, Accuracy, Both brain development, good concentration and Visualisation through Abacus learning, which naturally improves students learning ability.</p>
