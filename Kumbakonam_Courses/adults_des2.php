...
<head>
    ...
    <title>Samuthrika Academy Speedwriting Adults Kumbakonam</title>
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            ...
                                            data-zoom-image="<?php echo $path;?>assets/images/speed-write.jpg"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span class="price old-price basic-price">₹1,500</span><span
                                        class="price basic-price" id="price">₹1000</span>
                                </div>
                                <!-- End Product Price -->
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p style="text-align: left;">
                                            Speedwriting is a course taken to improve speed in writing, which can be
                                            done only after improving Handwriting.
                                            We follow a methodology <br> that will improve the speed of writing without
                                            changing the handwriting, and it definitely shows good improvement.
                                        </p>

                                        <h4 class="mb-3">Features</h4>
                                        <ul class="checkmark-info">
                                            <li> Increases speed in writing</li>
                                            <li> Maintains good Handwriting</li>
                                            <li>Can be done only after improving Handwriting</li>
        ...
        <script>
            ...
            $("#submit").click(function () {
                ...
                if (cookieValue === null) {
                    ...
                    fd.append('id',"79");
                    fd.append('course_name', "Speedwriting");
