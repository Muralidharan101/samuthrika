...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy School Tuition For Class-8 In Kumbakonam</title>
    <!--BootStrap icons-->
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/classes.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/classes.jpg" alt="product"
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-price d-flex-center my-2">
                                        <span class="price old-price">₹3,500</span><span class="price">₹43000</span>
                                    </div>
                                    <!-- End Product Price -->
                                </div>
                                <!-- End Product Details -->
