...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy HandWriting Adults Kumbakonam</title>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span class="price old-price basic-price" id="dup_price">₹2,000</span><span
                                        class="price basic-price" id="price">₹1500</span>
