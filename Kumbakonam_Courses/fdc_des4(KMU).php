                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">One Month Diploma In Fashion Designing
                                </h2>
                                <!-- Product Info -->
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span  class="price old-price ">₹35,000</span><span
                                         class="price ">₹20000</span>
                                </div>
                                <!-- End Product Price -->
