...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Yoga Class Adults Kumbakonam</title>
    <!--BootStrap icons-->
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/yoga.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/yoga.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Yoga
                                </h2>
                                <!-- Product Info -->
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Level :
                                        <span>
                                            <div class="form-check basicAdvance">
                                                ...
                                                <label for="basic" class="me-3">Basic - 20 hrs/per day 1hr</label>
                                                <br>
                                                <input id="advance" name="level" type="radio" value="advance" />

                                                <label for="advance">Advance - 20 hrs/6months (Weekly 5 days)</label>
                                            </div>
                                        </span>
                                    </p>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price basic-price ">₹1,500</span><span
                                        style="display:none" class="price basic-price bprice">₹1000</span>
                                    <span style="display:none" class="price old-price advance-price ">₹2,000</span><span
                                        style="display:none" class="price advance-price aprice">₹1500</span>
                                </div>
                                <!-- End Product Price -->
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>
                                            Yoga is a perfect art which helps us to keep healthy. We conduct regular
                                            yoga sessions and encourage both kids and adults to practice regularly</p>
                                        ...
                                        <ul class="checkmark-info">
                                            ...
                                            <li>Outside Shows are available for participation on interests for yogasanas</li>
