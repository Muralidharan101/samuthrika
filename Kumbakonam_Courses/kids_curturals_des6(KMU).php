...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Keyboard Kids Kumbakonam</title>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <!--Breadcrumbs-->
                            <div class="breadcrumbs"><span class="main-title fw-bold">MSUIC CLASSES</span></div>
                            <!--End Breadcrumbs-->
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/piano.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/piano.jpg"
                        ...
                        <div id="description" class="tab-content">
                            <div class="product-description">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>Keyboard is a musical instrument, where we learn both for time pass as well
            ...
            $("#submit").click(function () {
                ...
                if (cookieValue === null) {
                    ...
                    if (week == null) {
                        ...
                        fd.append("id","108");
                        fd.append('course_name', "Keyboard");
