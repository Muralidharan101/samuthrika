...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Spoken English Adults Kumbakonam</title>
    <!--BootStrap icons-->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price basic-price ">₹2,000</span><span
                                        style="display:none" class="price basic-price bprice">₹1500</span>
                                    <span style="display:none" class="price old-price advance-price ">₹5,500</span><span
                                        style="display:none" class="price advance-price aprice">₹5000</span>
                                </div>
                                <!-- End Product Price -->
