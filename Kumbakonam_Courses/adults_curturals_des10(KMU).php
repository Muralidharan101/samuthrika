...
<style>
    ...
    .basicAdvance #twice, #thrice , #fivedays, #weekend {
       accent-color:black;
    }
</style>
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            ...
                                            data-zoom-image="<?php echo $path;?>assets/images/flute.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 id="courseName" class="product-main-title" style="text-transform: capitalize;">Flute Class
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Timing :
                                        ...
                                        <input id="twice" name="week" type="radio" value="twice" required />
                                                ...
                                                <input id="thrice" name="week" class="ms-2" type="radio"  value="thrice" required />
...
<br>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price twice-price">₹1,500</span><span  style="display:none" class="price twice-price">₹1000</span>

                                    <span  style="display:none" class="price old-price thrice-price">₹1,700</span><span  style="display:none" class="price thrice-price">₹1200</span>
