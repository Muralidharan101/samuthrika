                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Certificate Course Specially for <br> Home Makes & Students
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Courses: <span>
                                           <ul>
                                            <li  class="ps-2">➤ Basics</li>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span  class="price old-price ">₹20,000</span><span
                                         class="price ">₹15000</span>
                                </div>
                                <!-- End Product Price -->
