                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-12 col-12 product-layout-img mb-4 mb-md-0">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <!-- Product Image -->
                                    <div class="zoompro">
                                        <img id="prod_img" alt="" width="500" height="300">
                                    </div>
                                    <!-- End Product Image -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;" id="product_name">
                                    HandWriting Class</h2>

                                <!-- Product Info -->

                                <h5 class="product-main-title" style="text-transform: capitalize;" id="product_code">
                                    HandWriting Class</h5>
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Languages: <span><a
                                                href="#">Tamil</a> <a href="#">/</a> <a href="#">English</a> <a
                                                href="#">/</a> <a href="#">Hindi</a> </span></p>
                                ...
                                <div class="product-price d-flex-center my-2">
                                    <span class="price" id="product_price">₹1000</span>
                                </div>
                                <!-- End Product Price -->
                            ...
                            <form method="post" action="#" class="product-form product-form-border hidedropdown">
                                  ...
                                  <div class="product-action w-100 d-flex-wrap mb-3">
                                        ...
                                        <div class="product-form-submit addcart fl-1 ms-0 mt-3">
                                            <button type="submit" name="add" class="btn btn-secondary product-form-cart-submit" id="add-to-cart"><span>Add to cart</span></button>
                                        </div>
                                        <!-- Product Add -->
                                        <!-- Product Buy -->
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                function fetchdata() {
                    ...
                    $.ajax({
                        url: 'dashboard/main/ajax/jewel/edit_list_jewel.php',
                        type: 'post',
                        contentType: false,
                        processData: false,
                        data: fd,
                        ...
                        success: function (response) {
                            ...
                            if (result.status == 'Success') {
                                ...
                                data.map(function (value) {
                                    ...
                                    product_img.src =
                                        `dashboard/main/product_jewel_images/${value.id}/${value.product_img}`;
                                    ...
                                    function addItemToCart(item, chosenQuantity) {
                                           const existingItem = globalCart.find(cartItem =>
                                            ...
                                            updateCart(); // This function is called to save the cart data in cookies.
                                        }
                                    ...
                                    const itemIndex = globalCart.findIndex(cartItem =>
                                        `${cartItem.id} ${cartItem.category}` === itemKey);
                                    ...
                                    submit_btn.addEventListener("click", function (e) {
                                        ...
                                        const itemCategory = productCategory;

                                        // Get the chosen quantity from the webpage
                                        ...
                                        addItemToCart(item, chosenQuantity);
                                    })
