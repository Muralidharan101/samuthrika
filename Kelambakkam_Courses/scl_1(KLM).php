...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy School Tuition For Class-1 Kelambakkam</title>
    <!--BootStrap icons-->
                                ...
                                <div class="product-info">
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Hours : <span>
                                            <div class="form-check hour">
                                                ...
                                                <label for="six" class="me-3">6 hrs (Weekend Only)/ 24 hrs Per
                                                    Month</label>
                                    ...
                                    <div class="product-price d-flex-center my-2">
                                        <span class="price old-price">₹2,500</span><span class="price"
                                            id="price">₹2000</span>
                                    </div>
                                    <!-- End Product Price -->
