...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy English Reading and Writing Adults Kelambakkam</title>
    <!--BootStrap icons-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">English Reading &
                                    Writing
                                </h2>
                                <!-- Product Info -->
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Level :
                                        <span>
                                            <div class="form-check basicAdvance">
                                                ...
                                                <label for="advance">Advance - 40 days</label>
                                            </div>
                                        </span>
                                    </p>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span style="display:none" class="price old-price advance-price ">₹4,500</span><span
                                        style="display:none" class="price advance-price aprice">₹4000</span>
                                </div>
                                <!-- End Product Price -->
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>This course will have separate curriculum for both Adults and Kids and mainly
                                            focus on their personal interests in learning depending on their needs and
                                            issues. </p>
                                        <h4 class="mb-3">Features</h4>
                                        <ul class="checkmark-info">
                                            <li>Basic and Advance Courses are available</li>
                                            <li> Available for both Adults and kids</li>
                                            <li>Qualified Masters</li>
                                            <li>Appropriate Curriculum</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
