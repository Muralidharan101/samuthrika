...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Tailoring Kelambakkam</title>
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/tailor.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/tailor.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Tailoring
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Courses: <span>
                                            <ul>
                                                <li class="ps-2">➤ Normal</li>
                                                <li class="ps-2">➤ Chudi & Blouse</li>
                                                <li class="ps-2">➤ Cutting & Stitching</li>
                                                <li class="ps-2">➤ Measurements Given & Taken</li>
                                                <li class="ps-2">➤ Lining & Without Lining</li>
                                            </ul>
                                        </span></p>

                                    <p class="product-cat"><i class="bi bi-clock"></i> Duration: <span>
                                           40 Hours
                                        </span></p>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span class="price old-price basic-price" >₹6,000</span><span
                                        class="price basic-price" id="price" >₹5000</span>
