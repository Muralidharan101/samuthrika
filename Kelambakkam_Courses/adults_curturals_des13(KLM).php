...
<head>
    ...
    <title>Samuthrika Academy Karate Adults Kelambakkam</title>
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/karate.jpg "
                                            data-zoom-image="<?php echo $path;?>assets/images/karate.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Karate
                                </h2>
                                <!-- Product Info -->
