...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy One Day Workshop Kelambakkam</title>
    <!-- Favicon -->
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="sdc_des5(KLM).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="<?php echo $path; ?>assets/images/ows.jpg"
                                                src="<?php echo $path; ?>assets/images/ows.jpg" alt="Product"
                                    ...
                                    <div class="product-details text-left">
                                        <!--Product Vendor-->
                                        <div class="product-vendor">Workshop ARTS & CRAFTS </div>
                                        <!--End Product Vendor-->
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="sdc_des5(KLM).php">One Day Workshop </a>
                                            </div>
                                            <!-- End Product Name -->
