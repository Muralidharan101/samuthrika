...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Zumba Adults Kelambakkam</title>
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price twice-price">₹2,000</span><span
                                        style="display:none" class="price twice-price tp">₹1500</span>

                                    <span style="display:none" class="price old-price thrice-price">₹2,500</span><span
                                        style="display:none" class="price thrice-price thp">₹2000</span>


                                    <span style="display:none" class="price old-price five-price">₹3,000</span><span
                                        style="display:none" class="price five-price fp">₹2500</span>


                                    <span style="display:none" class="price old-price weekend-price">₹2,000</span><span
                                        style="display:none" class="price weekend-price wp">₹1500</span>
                                </div>
                                <!-- End Product Price -->
