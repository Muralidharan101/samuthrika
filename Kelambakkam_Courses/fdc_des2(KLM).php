...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Advanced Diploma In Fashion Designing Kelambakkam</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Advanced Diploma In Fashion Designing
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Courses: <span>
                                           <ul>
                                            <li  class="ps-2">➤ Advanced Draping</li>
                                            <li  class="ps-2">➤ Advanced Pattern Making</li>
                                            <li  class="ps-2">➤ Basic Haute Couture</li>
                                            <li  class="ps-2">➤ Product Design and Display</li>
                                            <li  class="ps-2">➤ Photography</li>
                                            <li  class="ps-2">➤ Softwares</li>
                                            <li  class="ps-2">➤ Fashion Styling</li>
                                            <li  class="ps-2">➤ Fashion Communication & Boutique Management</li>
                                           </ul>
                                        </span></p>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span  class="price old-price ">₹50,000</span><span
                                         class="price tprice">₹35000</span>
                                </div>
                                <!-- End Product Price -->
        ...
        function getCookie(cookieName) {
           ...
           $("#submit").click(function(){
            ...
            if(cookieValue === null){
                ...
                var fd = new FormData();
                fd.append("id","183");
                fd.append("course_name","Advanced Diploma In Fashion Designing");
