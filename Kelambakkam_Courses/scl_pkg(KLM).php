...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy School Tuition For Class-Pre KG In Kelambakkam</title>
    <!--BootStrap icons-->
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/Class-pkg.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/Class-pkg.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Subjects :<span><a href="#">All
                                                Subjects</a></span></p>
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Hours : <span>
                                            <div class="form-check hour">
                                                ...
                                                <input id="two" name="hour" type="radio" value="tamil" />
                                    ...
                                    <div class="product-price d-flex-center my-2">
                                        <span class="price old-price">₹2,000</span><span class="price">₹1500</span>
                                    </div>
                                    <!-- End Product Price -->
