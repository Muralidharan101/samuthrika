...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy hindi Reading and Writing adults Kelambakkam</title>
    <!--BootStrap icons-->
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/english class.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/english class.jpg"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Hindi Reading &
                                    Writing
                                </h2>
                                <!-- Product Info -->
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>Hindi Reading and Writing involves from badic to advance. End of the course
                                            we ensure good reading and writing ability.</p>
                                        <h4 class="mb-3">Features</h4>
                                        <ul class="checkmark-info">
                                            <li>From basic letters and their pronunciations.</li>
                                            <li>Basic and Advance courses are available</li>
                                            <li>Appropriate curriculum for both Adults and Kids</li>
