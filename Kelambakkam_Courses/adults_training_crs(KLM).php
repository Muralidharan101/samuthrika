...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Training Course For Adults Kelambakkam</title>
    <!-- Favicon -->
        ...
        <div id="page-content">
            ...
            <section style="padding-top:10px" class="section product-slider">
                ...
                <div class="section-header">
                        ...
                        <h1 style="font-size:2rem ; color:orange;" class="">TRAINING COURSES FOR ADULTS - KELAMBAKKAM</h1>
                    </div>
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="adults_des(KLM).php" class="product-img">
                                            <!-- Image -->
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            ...
                                            <div class="product-name">
                                                <a href="adults_des(KLM).php">Handwriting</a>
                                            </div>
                                            <!-- End Product Name -->
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_des2(KLM).php">Speedwriting</a>
                                            </div>
                                            <!-- End Product Name -->
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_des3(KLM).php">Calligraphy</a>
                                            </div>
                                            <!-- End Product Name -->
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_des4(KLM).php">Spoken English</a>
                                            </div>
                                            <!-- End Product Name -->
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_des5(KLM).php">Spoken Hindi</a>
                                            </div>
                                            <!-- End Product Name -->
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_des6(KLM).php">Hindi Reading & Writing
                                                    </a>
                                            </div>
                                            <!-- End Product Name -->
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="adults_des7(KLM).php">English Reading & Writing
                                                    </a>
                                            </div>
                                            <!-- End Product Name -->
                    ...
                    <div class="section-header mt-5">
                        ...
                        <h1 style="font-size:2rem ; color:orange;" class="">SUMMER CAMP FOR ADULTS - KELAMBAKKAM</h1>
                    </div>
