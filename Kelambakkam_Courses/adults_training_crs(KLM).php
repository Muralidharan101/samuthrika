            ...
            <div id="page-content">               
                ...
                <section style="padding-top:10px" class="section product-slider">
                    ...
                    <div class="section-header">
                            ...
                            <div class="row col-row product-options row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2">                                                                              
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                ...
                                                <div class="product-name">
                                                    <a href="adults_des(KLM).php">Handwriting Classes</a>
                                                </div>
                                                <!-- End Product Name -->
                                ...
                                <div class="item col-item">
                                    <div class="product-box">
                                        ...
                                        <div class="product-image">
                                            <!-- Start Product Image -->
                                            <a href="adults_des2(KLM).php" class="product-img">
                                                   <!-- Image -->
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="adults_des2(KLM).php">Speed Writing Class</a>
                                                </div>
                                                <!-- End Product Name -->
                                ...
                                <div class="item col-item">
                                    <div class="product-box">
                                        ...
                                        <div class="product-image">
                                            <!-- Start Product Image -->
                                            <a href="adults_des3(KLM).php" class="product-img">
                                                   <!-- Image -->
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="adults_des3(KLM).php">Calligraphy Class</a>
                                                </div>
                                                <!-- End Product Name -->
                                ...
                                <div class="item col-item">
                                    <div class="product-box">
                                        ...
                                        <div class="product-image">
                                            <!-- Start Product Image -->
                                            <a href="adults_des4(KLM).php" class="product-img">
                                                   <!-- Image -->
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="adults_des4(KLM).php">Spoken English Class</a>
                                                </div>
                                                <!-- End Product Name -->
                                ...
                                <div class="item col-item">
                                    <div class="product-box">
                                        ...
                                        <div class="product-image">
                                            <!-- Start Product Image -->
                                            <a href="adults_des5(KLM).php" class="product-img">
                                                   <!-- Image -->
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="adults_des5(KLM).php">Spoken Hindi Class</a>
                                                </div>
                                                <!-- End Product Name -->
                                ...
                                <div class="item col-item">
                                    <div class="product-box">
                                        ...
                                        <div class="product-image">
                                            <!-- Start Product Image -->
                                            <a href="adults_des6(KLM).php" class="product-img">
                                                   <!-- Image -->
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="adults_des6(KLM).php">Hindi Reading & Writing Classes</a>
                                                </div>
                                                <!-- End Product Name -->
                                ...
                                <div class="item col-item">
                                    <div class="product-box">
                                        ...
                                        <div class="product-image">
                                            <!-- Start Product Image -->
                                            <a href="adults_des7(KLM).php" class="product-img">
                                                   <!-- Image -->
                                        ...
                                        <div class="product-details text-left">
                                            ...
                                            <div class="product-name-price">
                                                <!-- Product Name -->
                                                <div class="product-name">
                                                    <a href="adults_des7(KLM).php">English Reading & Writing Classes</a>
                                                </div>
                                                <!-- End Product Name -->
                        ...
                        <h1 style="font-size:2rem ; color:orange;" class="">SUMMER CAMP FOR ADULTS IN KELAMBAKKAM</h1>
                    </div>
                        ...
                        <div
                            ...
                            <div class="item col-item">
                                <div class="product-box">
                                    ...
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="summer_camp_adults(KLM).php" class="product-img">
                                            <!-- Image -->
                                    ...
                                    <div class="product-details text-left">
                                        ...
                                        <div class="product-name-price d-flex-nowrap justify-content-between">
                                            <a href="summer_camp_adults(KLM).php">SUMMER CAMP FOR ADULTS</a>
