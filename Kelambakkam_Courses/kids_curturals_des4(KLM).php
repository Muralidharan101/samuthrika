...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Dance on floor Kids Kelambakkam</title>
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/dancing_floor.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/dancing_floor.jpg"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price twice-price">₹1,500</span><span
                                        style="display:none" class="price twice-price tp">₹1000</span>

                                    <span style="display:none" class="price old-price thrice-price">₹1,700</span><span
                                        style="display:none" class="price thrice-price thp">₹1200</span>


                                    <span style="display:none" class="price old-price five-price">₹2,000</span><span
                                        style="display:none" class="price five-price fp">₹1500</span>


                                    <span style="display:none" class="price old-price weekend-price">₹1,500</span><span
                                        style="display:none" class="price weekend-price wp">₹1000</span>
                                </div>
                                <!-- End Product Price -->
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>This is our Academy’s special program, where any student can dance together
                                            with the Master for stress relief and no worries about perfection. Just to
                                            encourage to enjoy dancing we have this course and it definitely useful.</p>
                                        <h4 class="mb-3">Features</h4>
                                        <ul class="checkmark-info">
                                            <li>Specially for Stress relief and work pressure</li>
                    ...
                    $("#submit").click(function () {
                        ...
                        if (cookieValue === null) {
                            ...
                            if (week == null) {
                                ...
                                fd.append("id", "194");
                                fd.append('course_name', "Dancing On Floor");
