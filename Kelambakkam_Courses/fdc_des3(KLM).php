...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Master Diploma in Fashion Designing Kelambakkam</title>
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/mdfd.jpg" alt="product" width="600"
                                            height="800" /></div>
                                    <!-- End Product Image -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Master Diploma In
                                    Fashion Designing
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Courses: <span>
                                            <ul>
                                                <li class="ps-2">➤ Introduction to Textile Fibers</li>
                                                <li class="ps-2">➤ Pattern Making and Grading</li>
                                                <li class="ps-2">➤ Fashion Sketching</li>
                                                <li class="ps-2">➤ Elements of Fashion Designing</li>
                                                <li class="ps-2">➤ Fundamental of Designing</li>
                                                <li class="ps-2">➤ Basic of Textile Wet Processing</li>
                                                <li class="ps-2">➤ Apparel Costing and Mechandising</li>
                                                <li class="ps-2">➤ Emblishment</li>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span class="price old-price ">₹1,10,000</span><span
                                        class="price tprice">₹80000</span>
                                </div>
                                <!-- End Product Price -->
        ...
        <script>
            ...
            $("#submit").click(function () {
                ...
                if (cookieValue === null) {
                    ...
                    var fd = new FormData();
                    fd.append("id", "184");
                    fd.append("course_name", "Master Diploma In Fashion Designing");
