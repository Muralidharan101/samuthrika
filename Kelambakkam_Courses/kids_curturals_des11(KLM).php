                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/veenai.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/veenai.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 id="courseName" class="product-main-title" style="text-transform: capitalize;">Veena
                                    Class
                                </h2>
                                <!-- Product Info -->
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    ...
                                    <span style="display:none" class="price old-price thrice-price">₹1,700</span><span
                                        style="display:none" class="price thrice-price">₹1200</span>


                                    <span style="display:none" class="price old-price five-price">₹2,000</span><span
                                        style="display:none" class="price five-price">₹1500</span>


                                    <span style="display:none" class="price old-price weekend-price">₹1,500</span><span
                                        style="display:none" class="price weekend-price">₹1000</span>
                                </div>
                                <!-- End Product Price -->
