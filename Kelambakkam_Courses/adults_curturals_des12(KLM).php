...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Cultural classes kelambakkam</title>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <!--Breadcrumbs-->
                            <div class="breadcrumbs"><span class="main-title fw-bold">TRADITIONAL CLASSES</span></div>
                            <!--End Breadcrumbs-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 id="courseName" class="product-main-title" style="text-transform: capitalize;">Yoga
                                    Class
                                </h2>
                                <!-- Product Info -->
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Timing :
                                        <span>
                                            <div class="form-check basicAdvance">
                                                ...
                                                <label for="twice" class="me-3">Basic - 20 hours</label>
                                                <input id="thrice" name="week" class="ms-2" type="radio" value="thrice"
                                                    required />

                                                <label for="thrice" class="me-5">Advance - 40 hours</label>
                                                <br>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price twice-price">₹1,500</span><span
                                        style="display:none" class="price twice-price">₹1000</span>

                                    <span style="display:none" class="price old-price thrice-price">₹2,500</span><span
                                        style="display:none" class="price thrice-price">₹2000</span>


                                    <!-- <span  style="display:none" class="price old-price five-price">₹2,000</span><span  style="display:none" class="price five-price">₹1500</span>

                                    
                                    <span  style="display:none" class="price old-price weekend-price">₹1,500</span><span  style="display:none" class="price weekend-price">₹1000</span> -->
                                </div>
                                <!-- End Product Price -->
