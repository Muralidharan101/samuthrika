...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy School Tuition For Class-11 In Kelambakkam</title>
    <!--BootStrap icons-->
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/Class-11.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/Class-11.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="product-info">
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-eye-r"></i> Enquiry :<span><h2
                                                href="#" style="color:red;">&nbsp;DIRECT ADMISSIONS ONLY</h2>
                                    </p>
