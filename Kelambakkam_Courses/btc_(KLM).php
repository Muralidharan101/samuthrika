...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Beautician Courses Kelambakkam</title>
    <!-- Favicon -->
            ...
            <section style="padding-top:10px" class="section product-slider">
                <div class="container">
                    ...
                    <div class="grid-products grid-view-items pro-hover3">
                        <div
                            class="row col-row product-options row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2 justify-content-center">
                            <div class="item col-item">
                                <div class="product-box">
                                    <!-- Start Product Image -->
                                    <div class="product-image">
                                        <!-- Start Product Image -->
                                        <a href="btc_des(KLM).php" class="product-img">
                                            <!-- Image -->
                                            <img class="primary blur-up lazyload"
                                                data-src="<?php echo $path; ?>assets/images/btc.png"
                                                src="<?php echo $path; ?>assets/images/btc.png"
                                    ...
                                    <div class="product-details text-left">
                                        <!--Product Vendor-->
                                        <div class="product-vendor">Beautician Course</div>
                                        <!--End Product Vendor-->
                                        <div class="product-name-price">
                                            <!-- Product Name -->
                                            <div class="product-name">
                                                <a href="btc_des(KLM).php">All Beautician Courses</a>
                                            </div>
                                            <!-- End Product Name -->
                                        ...
                                        <div class="product-duration py-2 pb-0">
                                            <ul
                                                ...
                                                <li style="font-size:11px;"><i class="bi bi-calendar-check"></i><span>
                                                        Course - 80hrs / 160hrs / 240 hrs / 360 hrs / <br> 480 hrs / 600 hrs / 720 hrs / 1320 hrs / 1560 hrs </span></li>
