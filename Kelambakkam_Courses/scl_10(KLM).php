                                ...
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Subjects :<span>
                                            <div class="form-check sub">
                                                ...
                                                <input id="all" name="sub" type="radio" value="all subjects" />

                                                <label for="all" class="me-3">All Subjects</label>

                                                <input id="sin" name="sub" type="radio" value="single subjects" />
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Hours : <span>
                                            <div class="form-check hour">
                                                ...
                                                <input id="two" name="hour" type="radio" value="2 hrs Per Day" />

                                                <label for="two" class="me-3">2 hrs Per day (40 hrs Per Month)</label>
<br>
                                                <input id="six" name="hour" type="radio" value="6 hrs Weekend Only" />
                                    ...
                                    <div class="product-price d-flex-center my-2">
                                        <span style="display:none" class="price old-price all-price">₹4,500</span><span
                                            style="display:none" class="price all-price aprice">₹4000</span>
                                        <span style="display:none" class="price old-price sin-price">₹2,500</span><span
                                            style="display:none" class="price sin-price sprice">₹2000</span>
                                    </div>
                                    <!-- End Product Price -->
                            ...
                            <div id="description" class="tab-content">
                                <div class="product-description">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                            <p>
                                                Regarding Education, we support Students and Parents by providing them
                                                with good good Teachers who guide them in completing School homeworks
                                                and teaching them and clearing doubts whenever necessary. We support day
                                                to day learning and help to score good marks in a friendly environment</p>
                                            <h4 class="mb-3">Features</h4>
                                            <ul class="checkmark-info">
                                                <li>From Pre-kg to 12 th Std.</li>
                                                <li>To all subjects or particular subjects needed by the students
                                                and parents</li>
                                                <li>Weekly 5 days / Daily 2 hours (or)
                                                Weekend 2 days / each day 3 hours</li>
                                                <li>Qualified Faculties</li>
                                                <li>Assured Improvement</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
    ...
    if (cookieValue == null) {
        ...
        if (sub == null) {
            toastr.error("Select Subject", "Empty !");
        } else if (hour == null) {
            toastr.error("Select Hour", "Empty !");
        } else {
            if (sub == "all subjects") {
                price = $(".aprice").text();
            } else if (sub == "single subjects") {
                price = $(".sprice").text();
            }
