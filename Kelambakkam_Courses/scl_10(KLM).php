...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy School Tuition For Class-10 In Kelambakkam</title>
    <!--BootStrap icons-->
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/Class-10.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/Class-10.jpg"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">School tuition class
                                    - 10</h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Subjects :<span>
                                            <div class="form-check sub">

                                                <input id="all" name="sub" type="radio" value="all" />

                                                <label for="all" class="me-3">All Subjects</label>

                                                <input id="sin" name="sub" type="radio" value="sin" />

                                                <label for="sin" class="me-3">Single Subjects</label>
                                    ...
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Hours : <span>
                                            <div class="form-check hour">
                                                ...
                                                <label for="two" class="me-3">2 hrs Per day (40 hrs Per Month)</label>

                                                <input id="six" name="hour" type="radio" value="six" />

                                                <label for="six" class="me-3">6 hrs (Weekend Only)</label>

                                            </div>
                                        </span></p>
                                    </p>
                                    <p class="product-cat"><i class="icon anm anm-calendar"></i> Days:<span><a
                                                href="#">Monday</a> <a href="#">-</a> <a href="#">Friday</a> / <a
                                                href="#"> Weekend only</a></span></p>
                                    ...
                                    <div class="product-price d-flex-center my-2">
                                        <span style="display:none" class="price old-price all-price">₹4,500</span><span
                                            style="display:none" class="price all-price">₹4000</span>
                                        <span style="display:none" class="price old-price sin-price">₹2,500</span><span
                                            style="display:none" class="price sin-price">₹2000</span>
                                    </div>
                                    <!-- End Product Price -->
        ...
        <div id="cart-drawer" class="block block-cart">
                ...
                <ul class="m-0 clearfix">
                    <li class="item d-flex justify-content-center align-items-center">
                        ...
                        <div class="qtyDetail text-center">
                            ...
                            <a href="#" class="edit-i remove"><i class="icon anm anm-pencil-ar" data-bs-toggle="tooltip"
            ...
            <div class="minicart-bottom">
                <div class="shipinfo">
                    ...
                    <div class="freeShipMsg"><i class="icon anm anm-truck-l fs-6 me-2 align-middle"></i>Only
                        <span class="money" data-currency-usd="$199.00" data-currency="USD">$199.00</span> away
                        from <b>Free Shipping</b></div>
                    <div class="freeShipMsg d-none"><i class="icon anm anm-truck-l fs-6 me-2 align-middle"></i>Congrats!
                        You are eligible
                        for <b>Free Shipping</b></div>
                </div>
                    ...
                    <form method="post" action="#" id="product-form-quickshop" class="product-form align-items-center">
                        ...
                        <div class="row g-0 item mb-3">
                            <a class="col-4 product-image" href="product-layout1.html"><img class="blur-up lazyload"
                                    ...
                                    src="<?php echo $path;?>assets/images/products/addtocart-modal.jpg" alt="Product"
                                    title="Product" width="625" height="800" /></a>
                            <div class="col-8 product-details">
                                <div class="product-variant ps-3">

                                    <a class="product-title" href="product-layout1.html">Weave Hoodie
                                        Sweatshirt</a>
                        ...
                        <div class="product-form-submit d-flex-justify-center">
                            ...
                            <button type="submit" name="buy" class="btn btn-secondary proceed-to-checkout">Buy
                                it now</button>
                        </div>
                        <!-- End Product Action -->
                        ...
                        <div class="row d-flex-center text-center">
                            ...
                            <div class="col-md-6 mt-3 mt-md-0">
                                ...
                                <div class="addcart-total">
                                    <p class="product-items mb-2">There are <strong>1</strong> items in your
                                        cart</p>
                                ...
                                <div class="product-form-submit d-flex-justify-center">
                                    ...
                                    <a href="cart-style1.html"
                                        class="btn btn-secondary product-viewcart w-100 my-2 my-md-3">View
                                        Cart</a>
                    ...
                    <div class="row">
                                ...
                                <div class="carousel-inner">
                                    <div class="item carousel-item active" data-bs-slide-number="0">
                                        <img class="blur-up lazyload"
                                            ...
                                            src="<?php echo $path;?>assets/images/products/product2.jpg" alt="product"
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="product-review d-flex mt-0 mb-2">
                                <div class="rating"><i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i
                                        class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i
                                        class="icon anm anm-star-o"></i></div>
                            ...
                            <div class="pro-stockLbl my-2">
                                <span class="d-flex-center stockLbl instock d-none"><span> In
                                        stock</span></span>
                                <span class="d-flex-center stockLbl preorder d-none"><span> Pre-order
                                        Now</span></span>
                                <span class="d-flex-center stockLbl outstock d-none"><span>Sold
                                        out</span></span>
                            </div>
                            <div class="product-price d-flex-center my-3">
                                <span class="price old-price">$135.00</span><span class="price">$129.00</span>
                            </div>
                            <div class="sort-description">The standard chunk of Lorem Ipsum used since the 1500s
                                is reproduced below for those interested.</div>
                            ...
                            <div class="wishlist-btn d-flex-center">
                                <a class="add-wishlist d-flex-center me-3" href="wishlist-style1.html"
                                    title="Add to Wishlist"><i class="icon anm anm-heart-l me-1"></i> <span>Add
                                        to Wishlist</span></a>
                                <a class="add-compare d-flex-center" href="compare-style1.html"
                                    title="Add to Compare"><i class="icon anm anm-random-r me-2"></i> <span>Add
                                        to Compare</span></a>
                            </div>
                            <!-- Social Sharing -->
                ...
                <div class="modal-body">
                    ...
                    <div id="sizechart" class="sizechart-wrap text-center">
                        ...
                        <p class="mb-4">This is a standardised guide to give you an idea of what size you will
                            need, however some brands may vary from these conversions.</p>
                ...
                <div class="modal-body">
                    ...
                    <div id="ShippingInfo" class="shippingInfo-wrap">
                        ...
                        <p>If you do not like the product you can return it within 15 days - no questions asked.
                            ...
                            hassle free return policy. Please look at our Delivery & Returns section for further
                            information.</p>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <div class="ratio ratio-16x9 productVideo-wrap">
                        <iframe src="https://www.youtube.com/embed/93A2jOW5Mog?rel=0" title="YouTube video"
