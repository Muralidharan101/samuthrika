...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Spoken English Adults Kelambakkam</title>
    <!--BootStrap icons-->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <!--Breadcrumbs-->
                            <div class="breadcrumbs"><span class="main-title fw-bold">Training Courses</span></div>
                            <!--End Breadcrumbs-->
                    ...
                    <div class="row">
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/spk-eng.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/spk-eng.jpg" alt="product"
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Spoken English
                                </h2>
                                <!-- Product Info -->
                                <div class="product-info">
                                    <p class="product-cat"><i class="bi bi-book"></i> Languages: <span><a
                                                href="#">English</a> </span></p>

                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Hours : <span><a
                                                href="#">per day/1 hr</a> </span></p>
                                    <p class="product-cat"><i class="icon anm anm-clock-r"></i> Level :
                                        <span>
                                            <div class="form-check basicAdvance">
                                                <input id="basic" name="level" type="radio" value="basic" />

                                                <label for="basic" class="me-3">Basic - 20 days</label>
                                                <br>
                                                <input id="advance" name="level" type="radio" value="advance" />

                                                <label for="advance">Advance - 60 days</label>
                                            </div>
                                        </span>
                                    </p>
                                    <p class="product-cat"><i class="icon anm anm-calendar"></i> Days: <span>
                                            Monday - Sunday
                                        </span></p>
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span style="display:none" class="price old-price basic-price ">₹2,500</span><span
                                        style="display:none" class="price basic-price bprice">₹2000</span>
                                    <span style="display:none" class="price old-price advance-price ">₹6,500</span><span
                                        style="display:none" class="price advance-price aprice">₹6000</span>
                                </div>
                                <!-- End Product Price -->
                            ...
                            <div class="product-action w-100 d-flex-wrap mb-2">
                                ...
                                <div class="product-form-submit addcart fl-1 ms-0 mt-0">
                                    <button name="add" class="btn btn-secondary product-form-cart-submit"
                                        id="submit"><span>Add to
                                            cart</span></button>
                                </div>
                                <!-- Product Add -->
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>
                                            English is just a language and we encourage students to communicate in
                                            English without fear and hesitation first through a good ice breaking
                                            course. As we all learning English from school to college, our confidence
                                            level goes down when we try to speak the English and we support and focus on
                                            this mainly and students shows better results. </p>
                                        <h4 class="mb-3">Features</h4>
                                        <ul class="checkmark-info">
                                            <li>Good and Assured results on completion</li>
                                            <li>Basic and Advance courses are available at convenient timings</li>
                                            <li>From Grammar to Advance level of English also available as a course</li>
                                            <li>Suitable curriculum for students who need to speak English within a short
                                            period especially new job goers</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            $("#submit").click(function () {
                ...
                if (cookieValue === null) {
                    ...
                    if (level == null) {
                        ...
                        fd.append('id',"177");
                        fd.append('course_name', "Spoken English");
