...
<head>
    ...
    <title>Samuthrika Academy Calligraphy Adults Kelambakkam</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                            ...
                            <div class="product-single-meta">
                                <h2 class="product-main-title" style="text-transform: capitalize;">Calligraphy
                                </h2>
                                <!-- Product Info -->
                                ...
                                <div class="product-price d-flex-center my-2 money">
                                    <span class="price old-price basic-price">₹3,000</span><span
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>
                                            It’s an art of writing and mainly useful for all age groups as an
                                            interesting art.  We certify Calligraphy students and they even engage
                                            themselves <br> in employing themselves in writing bulk Certificates.</p>
                                        <h4 class="mb-3">Features</h4>
                                        <ul class="checkmark-info">
                                            <li>Calligraphy is an Art of Writing</li>
                                            <li> We provide Certificates on completion</li>
                                            <li>Different fonts and styles are taught</li>
                                            <li>We provide books for practice</li>
        ...
        <script>
            ...
            $("#submit").click(function () {
                ...
                if (cookieValue === null) {
                    ...
                    fd.append('id',"176");
                    fd.append('course_name', "Calligraphy");
