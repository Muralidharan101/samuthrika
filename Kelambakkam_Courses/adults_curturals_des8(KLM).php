...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Drums Adults Kelambakkam</title>
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/drums.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/drums.jpg"
                        ...
                        <div id="description" class="tab-content">
                            <div class="product-description">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>Drums is a musical instrument, where we learn both for time pass as well
