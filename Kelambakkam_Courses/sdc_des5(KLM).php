...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Skill Development Courses Kelambakkam</title>
    ...
    <div class="page-wrapper">
        ...
        <div id="page-content">
            ...
            <div class="section-header">
                <h1 style="font-size:2.3rem" class="pt-4"> One Day <span style="color:orange;">Workshop</span></h1>
            </div>
                                    ...
                                    <div class="zoompro-span ">
                                        ...
                                        <center>
                                            <img id="zoompro" class="w-50"
                                                src="<?php echo $path;?>assets/images/ows.jpg" alt="product" width="600"
                                                height="800" />
                                        </center>
                                    </div>
                                    <br><br>
                            ...
                            <div class="product-single-meta">
                                ...
                                <div class="section-header">
                                    <h1 style="font-size:2.3rem" class="pt-4">Types Of <span
                                            style="color:orange;">Workshops</span></h1>
                                </div>
                                ...
                                <table id="product-table" class="table table-striped table-dark text-white">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Clay Works (DIY)</td>
                                            <td>Direct Enquiry</td>
                                        </tr>

                                        <tr>
                                            <td>2</td>
                                            <td>Saree Pre-Pleating</td>
                                            <td>Direct Enquiry</td>
                                        </tr>

                                        <tr>
                                            <td>3</td>
                                            <td>Traditional Painting (Canvas , Fabric , Mixed Media)</td>
                                            <td>Direct Enquiry</td>
                                        </tr>

                                        <tr>
                                            <td>4</td>
                                            <td>Accessories Making</td>
                                            <td>Direct Enquiry</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>6</td>
                                            <td>Liquid Embroidery</td>
                                            <td>Direct Enquiry</td>
                                        </tr>

                                        <tr>
                                            <td>7</td>
                                            <td>Tanjore Painting (Fabric)</td>
                                            <td>Direct Enquiry</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>10</td>
                                            <td>Fabric Emblishment Works</td>
                                            <td>Direct Enquiry</td>
                                        </tr>
