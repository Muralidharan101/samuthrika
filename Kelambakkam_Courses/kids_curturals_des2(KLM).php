...
<head>
    ...
    <!-- Title Of Site -->
    <title>Samuthrika Academy Western Dance Kids Kelambakkam</title>
                            ...
                            <div class="product-details-img product-horizontal-style">
                                ...
                                <div class="zoompro-wrap">
                                    ...
                                    <div class="zoompro-span"><img id="zoompro" class="w-100"
                                            src="<?php echo $path;?>assets/images/western.jpg"
                                            data-zoom-image="<?php echo $path;?>assets/images/western.jpg" alt="product"
                            ...
                            <div class="product-description">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-0 mb-md-0">
                                        <p>Dance classes from beginners level to advance level is available. Basic steps
                                            to start with are taught in a simple way.</p>
                    ...
                    $("#submit").click(function () {
                        ...
                        if (cookieValue === null) {
                            ...
                            if (week == null) {
                                ...
                                fd.append("id", "192");
                                fd.append('course_name', "Western Dance");
