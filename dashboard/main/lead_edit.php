                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" id="leadName" class="form-control" disabled>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" id="mobilenum" class="form-control" disabled>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form">
                                                            <div class="mt-5">
                                                    <button type="button" style="background-color:orange;" class="btn text-black  float-end mt-4" id="update">Update Lead</button>
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    if(result.status == 'Success')
                    {
                        ...
                        if (data.length > 0) {
                            var name = data[0].lead_name;
                            var mobile = data[0].phone;
                            var lead_req = data[0].lead_req;
