                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select" id="branch" readonly>
                                                        ...
                                                        <div class="mb-3">
                                                         ...
                                                         <div class="col-lg-3">
                                                            ...
                                                            <div class="mb-3">
                                                                    ...
                                                                    <input type="date" id="doj" class="form-control" readonly>
                                                            </div>

                                                                <div class="mt-2" >
                                                                    <label for="" class="mb-2">Gender <span style="color:red;">*</span></label><br>
                                                                    <div class="form-check form-check-inline">
                                                                        <input type="radio" id="male" value="male" name="gender" class="form-check-input" readonly >
                                                                        <label class="form-check-label" for="male">Male</label>
                                                                    </div>
                                                                    <div class="form-check form-check-inline">
                                                                        <input type="radio" id="female" name="gender" value="female" class="form-check-input" readonly >
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" id="perm-address" rows="5" readonly></textarea>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                             <div class="mb-3">
                                                                ...
                                                                <input type="text" id="emername" class="form-control" readonly>
                                                             </div>

                                                             <div class="mb-3">
                                                                <label for="emernum" class="form-label">Emergency Contact Number <span style="color:red;">*</span></label>
                                                                <input type="number" id="emernum" class="form-control" readonly>
                                                             </div>
                                                    </div><!-- End col -->
                                                    ...
                                                    <div class="col-lg-6">
                                                             ...
                                                             <div class="mb-3">
                                                                ...
                                                                <input type="number" id="refnum" class="form-control" readonly>
                                                            </div>
                                                    </div><!-- End col -->
                        ...
                        $.ajax({
                            ...
                            success:function(response)
                            {
                                ...
                                if(result.status == 'Success')
                                {
                                    ...
                                    document.getElementsByName('gender').value = gender;
