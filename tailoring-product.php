                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                        ...
                        <div class="grid-products grid-view-items">
                            <div
                                class="row col-row product-options row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2" id="cart-product">
...
$(document).ready(function(){
    ...
    function fetchdata(){   
                ...
                $.ajax({
                    url: 'dashboard/main/ajax/tailoring/list_tailoring.php',
                    type: 'get',
                        ...
                        <div class="item col-item" >
                            ...
                            <div class="product-box">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product_tailoring_desc.php?id=${value.id}" class="product-img rounded-0">
                                        
                                        <img class=""
                                            data-src="dashboard/main/product_tailoring_images/${value.id}/${value.product_img}"
                                            src="dashboard/main/product_tailoring_images/${value.id}/${value.product_img}"
                                ...
                                <div class="product-details text-left">
                                        <div class="product-vendor">Product-Tailoring</div>
                                    
                                    <div class="product-name">
                                        <a href="products-desc.php?id=${value.id}">${value.product_name}</a>
                                    </div>
