...
<div class="footer-top border-0 clearfix">
    <div class="container">                       
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 mb-4 mb-lg-0">
                ...
                <img src="<?php echo $path; ?>assets/images/samu.png" alt="Hema Multipurpose Html Template" title="Hema Multipurpose Html Template" class="footer-img" width="250" height="70"/><br>
    ...
    <p class="copytext" style="text-align:center;margin-top:2%;">2023 &copy; All Reserved By Samuthirka Academy  &nbsp; Designed By - <a href="https://cryptographicsolutions.in/">CryptoGraphic Solutions</a></p>
